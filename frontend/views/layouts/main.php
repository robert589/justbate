                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(Yii::$app->user->isGuest){ ?>
                        ...
                        <?php } else { ?>
                            ...
                            <li class="item"><a href="<?= $profile_link ?>"><img id="profile-picture-home" src=<?= Yii::getAlias('@image_dir') . '/'. User::findOne(Yii::$app->getUser()->id)->photo_path ?> height="20px;" /><?= User::findOne(Yii::$app->getUser()->id)->first_name ?></a></li>
