        ...
        <div style="margin-left: 120px; margin-bottom: 60px;" class="dropdown-comment-menu" data-service="<?= $comment_id ?>">
            <a class="outer">
                ...
                <table class="first" style="margin-bottom: 30px;">
                    <tbody>
                        <tr><td><button class="inner item edit_comment btn btn-block btn-default">Edit</button></td></tr>
                        <tr><td><button class="inner item delete_comment btn btn-block btn-danger">Delete</button></td></tr>
                    </tbody>
                </table>
            </a>
        </div>
