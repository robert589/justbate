...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div align="center"><h3>Give your vote</h3></div>
        ...
        <!-- User Option -->
        <?= $form->field($submitVoteModel, 'choice_text')->multiselect($thread_choice, ['style' => 'margin-left: 1%; border: 0 !important;', 'selector'=>'radio', 'check' => ['Agree']]) ?>
